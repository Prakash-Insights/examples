...
namespace WebApi.Models
{
    public static class SampleDbContextExtensions
    {
        ...
        public static async Task<StockItem> GetStockItemsAsync
            (this SampleDbContext dbContext, StockItem entity)
            => await dbContext.StockItems.FirstOrDefaultAsync(item => item.StockItemID == entity.StockItemID);

        public static async Task<StockItem> GetStockItemsByStockItemNameAsync
            (this SampleDbContext dbContext, StockItem entity)
    ...
    {
        public static IQueryable<TModel> 
            Paging<TModel>
            (
