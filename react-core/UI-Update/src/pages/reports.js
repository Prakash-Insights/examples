...
import { Button, Card, Checkbox, Col, DatePicker, PageHeader, Row, Upload, message, Select } from 'antd';
    ...
    return (
        <div>
            <Row>
                <>
                    <Card style={{
                        width: 985, display: "flex", justifyContent: "center", borderRadius: '30px',
            ...
            <Row >
                <Card style={{
                    width: 985, display: "flex", justifyContent: "center", borderRadius: '30px', marginTop: "10px",
                    marginbottom: '15px', border: '1px solid'
                }}>
                    <PageHeader className="site-page-header"
